...
// Models ==> LocationCity
const ModelData = require('../../../models/locations/city');

// ** GET RESOURCE
// INDEX 
exports.index = async (req, res, next) => {
    const reqCountryId = req.query.location_country_id;
    const reqStateId = req.query.location_state_id;

    const currentPage = +req.query.page || 1;
    const perPage = +req.query.per_page;
    try {
        const totalItems = await ModelData.find({ 
            location_country_id: reqCountryId,
            location_state_id: reqStateId,
        }).countDocuments();
        let listOfResource = await ModelData.find({ 
            location_country_id: reqCountryId,
            location_state_id: reqStateId,
        })
            .populate('location_country_id location_state_id')
        ...
        res.status(200).json({
            ...
            meta: {
                ...
                from: previousPage,
                last_page: lastPage,
                path: `${CONSTANTS.API_DOMAIN}/api/v1/location/city/get`,
                per_page: perPage,
                to: nextPage,
                total: totalItems
            },
...
exports.create = async (req, res, next) => {
    try {
        ...
        // request input
        const location_city_name = req.body.location_city_name;
        const location_country_id = req.body.location_country_id;
        const location_state_id = req.body.location_state_id;
        ...
        foundModelData.updateOne(
            {
                ...
                "location_city_name": req.body.location_city_name,
                "location_country_id": req.body.location_country_id,
                "location_state_id": req.body.location_state_id,
